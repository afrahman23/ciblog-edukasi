...
<div class="row justify-content-md-center">
        <div class="col-md-4">  
        <a class="btn btn-primary" href="<?php echo base_url() ?>users/registerGuru">Guru</a>
        <a class="btn btn-secondary" href="<?php echo base_url() ?>users/registersiswa">Siswa</a>
        <h1 class="text-center"><?=$title?></h1>
<?php echo validation_errors(); ?>
    <?php echo form_open('users/registerguru'); ?>
